...
public class EVS_admin_UserUpdate {
	
	 WebDriver driver;
	    Action action;
	    DataTable2 dataTable2;
	    
	    EVS_MagentoRetrieveCustomerDetailsPage magRetri ;
		EVS_MagentoAccountInformation magAccInfo;

	    public EVS_admin_UserUpdate(WebDriver driver, DataTable2 dataTable2) {
	        this.driver = driver;
	        PageFactory.initElements(driver, this);
	        action = new Action(driver);
	        this.dataTable2=dataTable2;
	        magRetri = new EVS_MagentoRetrieveCustomerDetailsPage(driver, dataTable2);
	    }
	...
	private WebElement applyFilter;
					...
					//*[@id="container"]/div/div[4]/table/tbody/tr[2]/td[20]/a
	@FindBy(xpath="//*[@id=\"container\"]/div/div[4]/table/tbody/tr[2]/td[20]/a")
    ...
    public void editCustomerDetails(ArrayList<HashMap<String, ArrayList<String>>> adminSheets,ExtentTest test,int testcaseID){
    	...
    	try {
			...
			magRetri.tableData(email, "Everyshop", test);
	    	...
	    	if(emailFlag.equalsIgnoreCase("yes")){
	    		...
	    		dataTable2.setValueOnCurrentModule("emailAddress_input", emailTextUpdated);
