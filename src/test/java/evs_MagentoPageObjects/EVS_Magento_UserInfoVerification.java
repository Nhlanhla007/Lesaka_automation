...
public class EVS_Magento_UserInfoVerification {
	...
	int ajaxTimeOutInSeconds = EVS_Magento_Login.ajaxTimeOutInSeconds;
	 public EVS_Magento_UserInfoVerification (WebDriver driver, DataTable2 dataTable2) {
			...
			MagentoRetrieveCustomer = new EVS_MagentoRetrieveCustomerDetailsPage(driver, dataTable2);
			PageFactory.initElements(driver, this);
			action = new Action(driver);
			registeredCustomerDetails = new ICDelivery(driver, dataTable2);
		}
	
	public EVS_Magento_UserInfoVerification() {
