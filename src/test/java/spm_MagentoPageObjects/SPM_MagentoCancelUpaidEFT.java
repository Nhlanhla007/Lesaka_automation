...
public class SPM_MagentoCancelUpaidEFT {

    WebDriver driver;
    Action action;
    DataTable2 dataTable2;
    int ajaxTimeOutInSeconds = SPM_Magento_Login.ajaxTimeOutInSeconds;

    public SPM_MagentoCancelUpaidEFT(WebDriver driver, DataTable2 dataTable2) {
        this.driver = driver;
