...
public class SPM_admin_UserUpdate {
	
	 WebDriver driver;
	    Action action;
	    DataTable2 dataTable2;
	    
	    SPM_MagentoRetrieveCustomerDetailsPage magRetri ;
		SPM_MagentoAccountInformation magAccInfo;

		int ajaxTimeOutInSeconds = EVS_Magento_Login.ajaxTimeOutInSeconds;
	    public SPM_admin_UserUpdate(WebDriver driver, DataTable2 dataTable2) {
	        this.driver = driver;
	        PageFactory.initElements(driver, this);
	        action = new Action(driver);
	        magRetri = new SPM_MagentoRetrieveCustomerDetailsPage(driver, dataTable2);
	    }
	...
	@FindBy(xpath="//button[contains(@data-action,'grid-filter-apply')]")
    ...
    public void editCustomerDetails(ArrayList<HashMap<String, ArrayList<String>>> adminSheets,ExtentTest test,int testcaseID){
    	...
    	try {
			...
			magRetri.tableData(email, "Sleepmasters", test);
