...
public class SPM_MagentoOrderSAPnumber {
    WebDriver driver;
    Action action;
    DataTable2 dataTable2;

    public SPM_MagentoOrderSAPnumber(WebDriver driver, DataTable2 dataTable2) {
        this.driver = driver;
    ...
    public void GenerateOrderSAPnumber(HashMap<String, ArrayList<String>> input, ExtentTest test, int rowNumber) throws Exception {
        ...
        String orderStatus = dataTable2.getValueOnOtherModule("SPM_OrderStatusSearch", "orderStatus", 0);
        ...
        try {
            String esdProduct = dataTable2.getValueOnOtherModule("SPM_ProductSearch", "ESD Product", 0);
