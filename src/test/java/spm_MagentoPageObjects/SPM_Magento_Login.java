...
public class SPM_Magento_Login {

	WebDriver driver;
	Action action;
	DataTable2 dataTable2;
	public static int ajaxTimeOutInSeconds;
		public SPM_Magento_Login(WebDriver driver, DataTable2 dataTable2) {
			this.driver = driver;
		...
		//vv
		public void SPM_LoginMagento(HashMap<String, ArrayList<String>> input,ExtentTest test,int rowNumber) throws Exception {
			String Username = "";
			String Password = "";
			ajaxTimeOutInSeconds = Integer.parseInt(dataTable2.getValueOnOtherModule("SPM_LoginMagento", "TimeOutInSecond", 0));
