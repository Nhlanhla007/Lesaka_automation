...
public class EVS_myTVLicense {
	WebDriver driver;
    Action action;
    DataTable2 dataTable2;
    
    public EVS_myTVLicense(WebDriver driver, DataTable2 dataTable2){
    	this.driver = driver;
    ...
    public void MyTVlicenseValidation(ExtentTest test) throws Exception {
    	String identityNumb = dataTable2.getValueOnOtherModule("evs_AccountCreation", "IDOrPassport", 0);
