...
public class ic_NavigetoWishlist {
	...
	public void NavigateToWishlist_verifymsg(ExtentTest test) throws IOException {
		// String url
		// =dataTable2.getRowUsingReferenceAndKey("URL","SUTURLS",dataTable2.getValueOnCurrentModule("loginDetails"),"url");
		// String Username
		// =dataTable2.getRowUsingReferenceAndKey("URL","SUTURLS",dataTable2.getValueOnCurrentModule("loginDetails"),"username");
		// String password
		// =dataTable2.getRowUsingReferenceAndKey("URL","SUTURLS",dataTable2.getValueOnCurrentModule("loginDetails"),"password");
		// ConfigFileReader configFileReader = new ConfigFileReader();
		// action.navigateToURL(url);
//
//		String url = dataTable2.getRowUsingReferenceAndKey("URL", "SUTURLS",
//				dataTable2.getValueOnOtherModule("ic_Login", "loginDetails", 0), "url");
		
		String url="https://staging-incredibleconnection-m23.vaimo.net/";
		...
		String ExpLoginType = dataTable2.getValueOnCurrentModule("Login_type");// "ExistingUser";//
																				// logedOn_user
																				// or
																				// ExistingUser
