...
import evs_PageObjects.EVS_MagentoOrderStatusPage;
import evs_PageObjects.EVS_NewAccountCreation;
import evs_PageObjects.EVS_PayUPayment;
import evs_PageObjects.EVS_PaymentOption;
import evs_PageObjects.EVS_RetriveOrderID;
...
public class JDGKeyManager {
	...
	public JDGKeyManager(WebDriver driver, DataTable2 dataTable2,
			LinkedHashMap<String, LinkedHashMap<String, ArrayList<String>>> dataMap2) {
		this.driver = driver;
	...
	public void runKeyWord(String actionToRun, int testcaseID, HashMap<String, Integer> occCount, ExtentTest test)
			throws Exception {
		...
		case "customerValidationUpdates":
			...
			// rowNumber = findRowToRun(dataMap2.get("accountCreation++"), 0,
			// testcaseID);
