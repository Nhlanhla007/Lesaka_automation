...
public class JDTests extends BaseTest {
	...
	public void runKeyWord(String actionToRun, ExtentTest test) throws Exception {
		...
		case "ic_SubscribeNews_DupliEmailID":
			ic_SubscribeNews_DupliEmailID.SubscribeNewsletter_DuplicateEmail(dataMap2.get(currentKeyWord + "++"), test1,
					rowNumber);
			break;
		...
		case "icEmailWishlistverification":
			icEmailWishlistverification.icWishlistVerificationSender(dataMap2.get(currentKeyWord + "++"), test1,
					rowNumber);
			break;
